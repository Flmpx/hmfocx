 ...
 * 
 * @note - This function is used to change the capacity of queue
 * 
 * @return - Return `hm_queue_ret_warn` when `size of queue` > `new_capacity`
 * @return - Return `hm_queue_ret_error` when malloc failure
